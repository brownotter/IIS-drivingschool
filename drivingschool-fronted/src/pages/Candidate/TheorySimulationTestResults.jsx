...
function TheorySimulationTestResults() {
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.main}>
                <h1 style={styles.title}>Theory Simulation Results</h1>
                ...
                {!loading && !errorMessage && result && (
                    <div style={styles.contentBox}>
                        ...
                        <div style={styles.card}>
                            ...
                            {result.domainsToImprove &&
                            result.domainsToImprove.length > 0 ? (
                                <ul style={styles.domainList}>
                                    {result.domainsToImprove.map((domain, index) => (
                                        <li key={index} style={styles.domainItem}>
                                            {domain}
                                        </li>
                                    ))}
                                </ul>
                        ...
                        <div style={styles.buttonContainer}>
                            <button
                                ...
                                onClick={() =>
                                    navigate("/candidate/theory-simulation")
                                }
                            >
                                BACK TO PROGRESS
                            </button>
...
export default TheorySimulationTestResults;