...
public class ProfessorAvailabilityServiceImpl
        implements ProfessorAvailabilityService {
    ...
    public ProfessorAvailability createAvailability(
        ...
        boolean overlap =
                availabilityRepository
                        .existsByProfessorAndAvailableDateAndStartTimeLessThanAndEndTimeGreaterThan(
                                professor,
        ...
        if (overlap) {
            throw new RuntimeException(
                    "Professor already has availability in this period"
            );
        }
